...
public class _AcquisitionStub
	extends org.omg.CORBA.portable.ObjectImpl
	implements ebank.bank.Acquisition
{
	...
	public final static java.lang.Class _opsClass = ebank.bank.AcquisitionOperations.class;
	public boolean process(long card_number, float amount, int dealer_account_number) throws ebank.InsufficientBalanceException,ebank.CardNumberException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_os.write_long(dealer_account_number);
				_is = _invoke(_os);
		...
		else
		{
			...
			AcquisitionOperations _localServant = (AcquisitionOperations)_so.servant;
			boolean _result;
			try
			{
				_result = _localServant.process(card_number,amount,dealer_account_number);
			}
			finally
			{
